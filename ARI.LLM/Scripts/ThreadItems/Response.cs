...
/// <summary>A URL visited by a web tool during a turn, with the content ARI actually saw.</summary>
...
public class Response : ThreadItem
{
    ...
    /// <summary>URLs (and their fetched content) visited by web tools during this turn, shown as Sources in the DTI block.</summary>
